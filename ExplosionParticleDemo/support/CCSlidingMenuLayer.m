...
#define ARROW_MENU_POS_RIGHT  ccp(430, 160)
...
- (void) initFrameSprite
{
    ...
    CCFrameSprite *frameSprite = [CCFrameSprite frameWithWidth:layerSize_.width height:layerSize_.height frameColor:frameColor_ frameBgColor:frameBgColor_];
    if (MENU_POSITION_ == MENU_POSITION_TOP) frameSprite.position = ccp(winSize.width / 2, winSize.height - layerSize_.height / 2);
    if (MENU_POSITION_ == MENU_POSITION_BOTTOM) frameSprite.position = ccp(winSize.width / 2, layerSize_.height / 2);
    if (MENU_POSITION_ == MENU_POSITION_LEFT) frameSprite.position = ccp(layerSize_.width / 2, winSize.height / 2);
    if (MENU_POSITION_ == MENU_POSITION_RIGHT) frameSprite.position = ccp(winSize.width - layerSize_.width / 2, winSize.height / 2);
